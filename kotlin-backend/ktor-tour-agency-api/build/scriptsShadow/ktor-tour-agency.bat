...
set CLASSPATH=%APP_HOME%\lib\ktor-tour-agency-all.jar

@rem Execute ktor-tour-agency
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %KTOR_TOUR_AGENCY_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%KTOR_TOUR_AGENCY_EXIT_CONSOLE%" exit 1
exit /b 1
